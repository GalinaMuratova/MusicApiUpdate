...
const run = async () => {
  ...
  const [artist1, artist2, artist3, artist4] = await Artist.create(
    ...
    },
    {
      name: 'Zemfira',
      information:
        'Российская рок-певица, музыкант, композитор, продюсер, поэтесса и автор песен. ',
      image: 'zemfira.jpg',
      isPublished: true,
    },
    {
      ...
      information:
        'My Chemical Romance (MCR) - это американская рок-группа, основанная в 2001 году. Группа прославилась своим уникальным стилем, который объединяет элементы панк-рока, эмо и альтернативного рока. Их музыка часто характеризуется глубокими текстами песен, эмоциональным вокалом и инновационным звуком. ',
      image: 'mcr.jpg',
      isPublished: false,
    },
  );

  const [album1, album2, album3, album4, album5, album6, album7, album8, album9] =
    await Album.create(
      {
